...
def main():
    ...
    bcb_monthly_path = fileloc["bacen_monthly"]  # or hardcode path / use file_locations.json
    df_bcb = pd.read_csv(bcb_monthly_path, index_col="date", parse_dates=True)

    # Make sure BCB column names match what you want to see on the plot
    # e.g. ["SELIC", "IPCA", "M4", ...] – adapt as needed
